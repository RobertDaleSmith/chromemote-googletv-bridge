...
package com.motelabs.chromemote.bridge.java.anymote.connection;
...
public final class KeyStoreManager {
    ...
    private static final String KEYSTORE_FILENAME = "anymote.keystore";
     ...
     */
    public void initialize(Platform context) throws GeneralSecurityException {
        mContext = context;
        load();
    ...
    private void generateAppCertificate() {
        ...
        try {
            ...
            mKeyStore.setKeyEntry(LOCAL_IDENTITY_ALIAS, keyPair.getPrivate(), KEYSTORE_PASSWORD, chain);
    ...
    private synchronized void store() {
        try {
            FileOutputStream fos = mContext.openFileOutput(KEYSTORE_FILENAME, Platform.MODE_PRIVATE);
    ...
    private final String getCertificateName(String id) {
        return "CN=anymote/" + mContext.getString(Platform.CERTIFICATE_NAME) + "/" + id;
    }
    ...
    private String getUniqueId() {
    	return mContext.getString(Platform.UNIQUE_ID);
    }
}
