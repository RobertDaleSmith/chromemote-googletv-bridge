...
public class TvDiscoveryService extends MessageThread {
    ...
    private synchronized void startBroadcast() {
        ...
        if (broadcastClient == null) {
            ...
            broadcastClient.setDeviceDiscoveredListener(new BroadcastDiscoveryClient.DeviceDiscoveredListener() {
                public void onDeviceDiscovered(BroadcastDiscoveryClient.BroadcastAdvertisement advert) {
     ...
     */
    protected TvDevice getDeviceFromAdvert(BroadcastDiscoveryClient.BroadcastAdvertisement adv) {
