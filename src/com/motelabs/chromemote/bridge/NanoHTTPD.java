...
public class NanoHTTPD
{
	...
	{
		System.out.println( "NanoHTTPD2 1.24 (C) 2001,2005-2011 Jarno Elonen and (C) 2010 Konstantinos Togias\n" +
		...
		**/
		private String saveTmpFile(byte[] b, int offset, int len)
		{
			...
			if (len > 0)
			{
				...
				try {
					File temp = File.createTempFile("NanoHTTPD2", "", new File(tmpdir));
		...
		**/
		...
		private void sendResponse( String status, String mime, Properties header, InputStream data , boolean isStreaming)
		{
			try
			{
                ...
                pw.print("Access-Control-Allow-Credentials: true"   + "\r\n");
                pw.print("Access-Control-Expose-Headers: FooBar"    + "\r\n");
